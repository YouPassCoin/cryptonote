...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x503b;
...
const uint64_t MONEY_SUPPLY                                  = (uint64_t)(18446744073709551616);
...
const char     CRYPTONOTE_NAME[]                             = "YouPassCoin";
